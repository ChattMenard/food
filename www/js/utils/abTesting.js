...
export function getABTesting() {
    if (!globalABTesting) {
        ...
        globalABTesting.registerExperiment('recipe-sorting', ['default', 'match-ratio-first'], {
            enabled: true
        });
        
        globalABTesting.registerExperiment('meal-suggestions', ['default', 'ai-enhanced'], {
            enabled: true
        });
        
        globalABTesting.registerExperiment('ui-density', ['comfortable', 'compact'], {
            enabled: false
        });
    }
