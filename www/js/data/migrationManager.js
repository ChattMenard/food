...
class MigrationManager {
    ...
    async migrate() {
        ...
        console.log('[Migration] Starting: v' + currentVersion + ' -> v' + targetVersion);
    ...
    async rollback(targetVersion) {
        ...
        if (targetVersion >= currentVersion) {
            return { success: false, error: 'Target version must be lower than current' };
        }

        console.log('[Migration] Rolling back: v' + currentVersion + ' -> v' + targetVersion);
