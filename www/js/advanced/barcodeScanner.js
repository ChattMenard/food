...
export class BarcodeScannerManager {
    ...
    prepareScannerOverlay() {
        ...
        if (!overlay) {
            ...
            overlay.className = 'fixed inset-0 bg-black z-50 flex items-center justify-center hidden';
            overlay.innerHTML = `
...
export async function scanAndAddToPantry(onAdd) {
    ...
    try {
        ...
        if (!available) {
            ...
            console.log('[BarcodeScanner] Barcode scanner not available, using photo capture');
