...
import { PushNotificationManager, NOTIFICATION_TYPES, PERMISSION } from '../utils/pushNotifications.js';
...
describe('PushNotificationManager', () => {
    ...
    describe('settings', () => {
        ...
        it('should enable notification type', async () => {
            ...
            expect(notificationManager.typeSettings.groceryDelivery.enabled).toBe(true);
            expect(notificationManager.getEnabledTypes()).toContain('groceryDelivery');
        });
        ...
        it('should throw for unknown type', async () => {
            await expect(notificationManager.setTypeEnabled('unknown', true))
    ...
    describe('scheduling', () => {
        ...
        it('should schedule daily notification', () => {
            ...
            expect(notificationManager.scheduledNotifications.has('expiration')).toBe(true);
        });

        it('should schedule weekly notification', () => {
            notificationManager.scheduleWeekly('mealPrep');
            
            expect(notificationManager.scheduledNotifications.has('mealPrep')).toBe(true);
        });
        ...
        it('should cancel scheduled notification', () => {
            ...
            expect(notificationManager.scheduledNotifications.has('expiration')).toBe(false);
        });
    ...
    describe('notification triggers', () => {
        ...
        it('should trigger grocery reminder', async () => {
            ...
            const result = await notificationManager.triggerGroceryReminder(['item1', 'item2']);
            expect(result).toBeDefined();
        });
        ...
        it('should trigger nutrition update', async () => {
            ...
            const result = await notificationManager.triggerNutritionUpdate({ percentage: 75 });
            expect(result).toBeDefined();
        });
        ...
        it('should trigger sync complete', async () => {
            ...
            const result = await notificationManager.triggerSyncComplete({ deviceName: 'Phone' });
            expect(result).toBeDefined();
        });
    });
    ...
    describe('pub-sub', () => {
        it('should notify on settings change', async () => {
            ...
            expect(callback).toHaveBeenCalledWith('settings-change', expect.any(Object));
        });
