...
import { MealPrepPlanner, PREP_STRATEGIES, STORAGE_GUIDELINES } from '../features/plan/mealPrepPlanner.js';
...
describe('MealPrepPlanner', () => {
    ...
    describe('strategy management', () => {
        ...
        it('should throw for unknown strategy', async () => {
            await expect(planner.setStrategy('unknown')).rejects.toThrow('Unknown strategy');
        });
    });
    ...
    describe('prep day management', () => {
        ...
        it('should reject invalid prep day', async () => {
            await expect(planner.setPrepDay(7)).rejects.toThrow('Prep day must be 0-6');
            await expect(planner.setPrepDay(-1)).rejects.toThrow('Prep day must be 0-6');
        });
    });
