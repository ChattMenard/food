...
import { GroceryDeliveryIntegration, PROVIDERS, SEARCH_MAPPINGS } from '../features/grocery/groceryDelivery.js';
...
describe('GroceryDeliveryIntegration', () => {
    ...
    describe('preferences', () => {
        ...
        it('should throw for unknown provider', async () => {
            await expect(groceryDelivery.setProvider('unknown')).rejects.toThrow('Unknown provider');
        });
        ...
        it('should validate ZIP code format', async () => {
            await expect(groceryDelivery.setZipCode('1234')).rejects.toThrow('Invalid ZIP');
            await expect(groceryDelivery.setZipCode('123456')).rejects.toThrow('Invalid ZIP');
        });
    ...
    describe('shopping list formatting', () => {
        ...
        it('should format list for provider', () => {
            const formatted = groceryDelivery.formatShoppingList(mockShoppingList, 'instacart');
        ...
        it('should include all item details', () => {
            const formatted = groceryDelivery.formatShoppingList(mockShoppingList, 'walmart');
    ...
    describe('price comparison', () => {
        ...
        it('should include provider features', () => {
            const comparison = groceryDelivery.comparePrices(mockShoppingList);
            const instacart = comparison.all.find(p => p.providerId === 'instacart');
