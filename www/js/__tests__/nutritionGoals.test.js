...
import { NutritionGoalsManager, DEFAULT_GOALS } from '../features/nutrition/nutritionGoals.js';
...
describe('NutritionGoalsManager', () => {
    ...
    describe('presets', () => {
        ...
        it('should throw for unknown preset', async () => {
            await expect(manager.setPreset('unknown')).rejects.toThrow('Unknown preset');
        });
