...
import { DeviceSyncManager, CONFLICT_STRATEGIES, DATA_TYPE_CONFIG } from '../data/deviceSyncManager.js';
...
describe('DeviceSyncManager', () => {
    ...
    describe('sync payload application', () => {
        ...
        it('should reject invalid payload', async () => {
            await expect(syncManager.applySyncPayload(null))
                .rejects.toThrow('Invalid sync payload');
        });
    ...
    describe('export/import', () => {
        ...
        it('should reject invalid backup on import', async () => {
            await expect(syncManager.importAllData(null))
    ...
    describe('conflict strategies', () => {
        ...
        it('should assign correct strategy to pantry', () => {
            expect(DATA_TYPE_CONFIG.pantry.strategy).toBe(CONFLICT_STRATEGIES.MERGE_ARRAYS);
            expect(DATA_TYPE_CONFIG.pantry.keyField).toBe('name');
        });

        it('should assign LAST_WRITE_WINS to preferences', () => {
            expect(DATA_TYPE_CONFIG.preferences.strategy).toBe(CONFLICT_STRATEGIES.LAST_WRITE_WINS);
        });

        it('should assign MAX_VALUE to recipe ratings', () => {
            expect(DATA_TYPE_CONFIG.recipeRatings.strategy).toBe(CONFLICT_STRATEGIES.MAX_VALUE);
        });
    });
});
