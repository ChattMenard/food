#!/usr/bin/env python3
"""
Validate the 100k Kaggle recipes before merging
"""
...
FOOD_KEYWORDS = {
    ...
    'mushroom', 'mushrooms', 'pepper', 'peppers', 'zucchini', 'squash', 'butternut squash', 'acorn squash', 'spaghetti squash', 'eggplant',
...
def main():
    input_file = Path('clean_100k_validated.json')
    output_file = Path('clean_100k_validated_filtered.json')
    rejected_file = Path('clean_100k_rejected_filtered.json')
